...
<table class="box_relatorio" width="1024" border="0">
	<tr class="cabecalho_tr">
		<td width="5%"><img style="cursor:pointer;" onclick="window.location.href='?mainapp=cadastro&app=sms_grupo'" src="imagens/botao_voltar.gif" title="Voltar" height="65%" /></td>
...
<form onsubmit="return SalvarItem('con_', 'contato', 'Grupo de SMS', 'con_nome')">
<table class="box_relatorio" width="350" align="center" border="1">
	...
	<tr class="tr_cor_branco">
		<td nowrap>SMS</td>
		<td><div align="left"><input name="SMS" type="text" id="con_email" size="60" maxlength="150" /></div></td>
	</tr>
	<tr class="subcabecalho_tr">
...
<table class="box_relatorio" border="1" align="center" width="300">
	<tr class="subcabecalho_tr" valign="middle">
		<td colspan="4">CONTATOS DO GRUPO DE SMS - <?php echo strtoupper($nome_grupo) ?></td>
	</tr>
		<tr class="tr_cor_branco">
			<td>NOME</td>
			<td>SMS</td>
