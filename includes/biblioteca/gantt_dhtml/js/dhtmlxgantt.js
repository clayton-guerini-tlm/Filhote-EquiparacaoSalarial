...
function GanttChart()
{
    ...
    this._isError = false;
    this.imgs = "../../includes/biblioteca/gantt_dhtml/imgs/"; //caminho da pasta no SIGO
    this.stylePath = "../css/dhtmlxgantt.css";
    this.shortMonthNames = ["Jan", "Fev", "Mar", "Abr", "Mai", "Jun", "Jul", "Ago", "Set", "Out", "Nov", "Dez"];
...

{
...

    {
         if (!isFile)try {
            ...
            //Tranforma a string XML em código XML e retorna se a string é válida ou não
            var retorno = this.xmlLoader.loadXMLString(content)
            if(!retorno )
...

{
    ...
    tblInfo.rows[0].cells[0].innerHTML += "<span class='st'>Início:&nbsp;</span><span class='ut'>" + this.TaskInfo.EST.getDate() + "." + (this.TaskInfo.EST.getMonth() + 1) + "." + this.TaskInfo.EST.getFullYear() + "</span><br/>";
    tblInfo.rows[0].cells[0].innerHTML += "<span class='st'>Duração:&nbsp;</span><span class='ut'>" + this.TaskInfo.Duration + " horas </span><br/>";
    tblInfo.rows[0].cells[0].innerHTML += "<span class='st'>Realizado:&nbsp;</span><span class='ut'>" + this.TaskInfo.PercentCompleted + "% </span><br/>";
    if (this.predTask){
        tblInfo.rows[0].cells[0].innerHTML += "<span class='st'>Predecessor:&nbsp;</span>";
        tblInfo.rows[0].cells[0].innerHTML += "<span class='ut'>" + this.TaskInfo.PredecessorTask.Name + "</span>"
        };
        
    if (this.TaskInfo.ChildTasks.length != 0){
        tblInfo.rows[0].cells[0].innerHTML += "<span class='st'>Tarefas Filhas:&nbsp;</span>";
...

{
    ...
    tblInfo.rows[0].cells[0].innerHTML += "<span class='st'>Início:&nbsp;</span><span class='ut'>" + this.Project.StartDate.getDate() + "." + (this.Project.StartDate.getMonth() + 1) + "." + this.Project.StartDate.getFullYear() + "</span><br/>";
    tblInfo.rows[0].cells[0].innerHTML += "<span class='st'>Duração:&nbsp;</span><span class='ut'>" + this.Duration + " horas</span><br/>";
    tblInfo.rows[0].cells[0].innerHTML += "<span class='st'>Realizado:&nbsp;</span><span class='ut'>" + this.percentCompleted + "%</span><br/>";
    this.Chart.divInfo.style.cssText = "z-index:2;position: absolute;display: inline;";
...

{
    ...
    this._errors[37] = "Não foi possível verificar a string XML! (Início diferente de '<?xml')"
    };
