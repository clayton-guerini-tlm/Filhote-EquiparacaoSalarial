     ...
     */
	 ...
	 function encodeSpecialChars($strValue){
	    ...
	    if ($this->encodeChars==true){
		    ...
		    $strValue=str_replace("Â¢","%a2",$strValue);
		    $strValue=str_replace("Â£","%a3",$strValue);
		    $strValue=str_replace("â¬","%E2%82%AC",$strValue);
		    $strValue=str_replace("Â¥","%a5",$strValue);
		    $strValue=str_replace("â£","%e2%82%a3",$strValue);
	    }else{
