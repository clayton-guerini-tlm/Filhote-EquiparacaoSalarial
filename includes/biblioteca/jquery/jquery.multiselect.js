			...
			return this.each(function () {
				...
				var divUpDown =
						"<div class='ms2side__updown'>" +
							"<p class='SelSort' title='Tipo'>" + o.labelSort + "</p>" +
							"<p class='MoveTop' title='Mova-se sobre a opção selecionada topo'>" + o.labelTop + "</p>" +
							"<p class='MoveUp' title='Mova para cima opção selecionada'>" + o.labelUp + "</p>" +
							"<p class='MoveDown' title='Mover para baixo opção selecionada'>" + o.labelDown + "</p>" +
							"<p class='MoveBottom' title='Seguir em frente opção selecionada fundo'>" + o.labelBottom + "</p>" +
						"</div>";
				...
				var htmlToAdd = 
					"<div class='ms2side__div'>" +
						...
						"<div class='ms2side__options'>" +
							...
							?
							("<p class='AddOne' title='Adicionar selecionado'>&rsaquo;</p>" +
							"<p class='AddAll' title='Adicionar Todos'>&raquo;</p>" +
							"<p class='RemoveOne' title='Remover Selecionados'>&lsaquo;</p>" +
							"<p class='RemoveAll' title='Remover Tudo'>&laquo;</p>")
							:
							("<p class='AddOne' title='Adicionar Selecionado'>&lsaquo;</p>" +
							"<p class='AddAll' title='Adicionar Todos'>&laquo;</p>" +
							"<p class='RemoveOne' title='Remover Selecionados'>&rsaquo;</p>" +
							"<p class='RemoveAll' title='Remover Tudo'>&raquo;</p>")
							) +
						"</div>" +
						"<div class='ms2side__select'>" +
				...
				// ON Alterar opções CLASSIFICAR SELECIONADOS
				var	nLastAutosort = 0;
				if (o.autoSort)
