...
class _database {
	...
	function __construct() {
		...
		if($this->settings["error_file"] === true) $this->settings["error_file"] = dirname(__FILE__)."/__mysqli_errors.log";
	}
	...
	function connect() {
		...
		if (!mysqli_select_db($this->settings["database"], $this->link)) $this->error();
	...
	function query($sql) {
		...
		if (!($this->result = mysqli_query($sql, $this->link))) $this->error($sql);
