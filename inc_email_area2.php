...
$cont_ro_c 						= 0;
$cont_df_c 						= 0;
// Armazena a contagem por filial dos não enviador por coordenadores
$cont_nao_enviador_c_ac 		= 0;
$cont_nao_enviador_c_go 		= 0;
$cont_nao_enviador_c_ms 		= 0;
$cont_nao_enviador_c_mt 		= 0;
$cont_nao_enviador_c_to 		= 0;
$cont_nao_enviador_c_ro		 	= 0;
$cont_nao_enviador_c_df			= 0;
...
// Armazena a contagem com o total por filial de encarregado, supervisor e coordenadores
$total_enviados_ac 				= 0;
$total_enviados_go 				= 0;
$total_enviados_ms 				= 0;
$total_enviados_mt 				= 0;
...
$detalha_nao_enviados_e_ac		= "";
$detalha_nao_enviados_e_go		= "";
$detalha_nao_enviados_e_ms		= "";
$detalha_nao_enviados_e_mt		= "";
$detalha_nao_enviados_e_to		= "";
$detalha_nao_enviados_e_ro		= "";
$detalha_nao_enviados_e_df		= "";

// Armazena os supervisores que não foram enviados
$detalha_nao_enviados_s_ac		= "";
$detalha_nao_enviados_s_go		= "";
$detalha_nao_enviados_s_ms		= "";
$detalha_nao_enviados_s_mt		= "";
$detalha_nao_enviados_s_to		= "";
$detalha_nao_enviados_s_ro		= "";
$detalha_nao_enviados_s_df		= "";

// Armazena os coordneadores que não foram enviados
$detalha_nao_enviados_c_ac		= "";
$detalha_nao_enviados_c_go		= "";
$detalha_nao_enviados_c_ms		= "";
$detalha_nao_enviados_c_mt		= "";
$detalha_nao_enviados_c_to		= "";
$detalha_nao_enviados_c_ro		= "";
$detalha_nao_enviados_c_df		= "";

// Armazena a tabela com a lista dos não enviados por filial
$tabela_nao_enviados_ac			= "";
$tabela_nao_enviados_go			= "";
$tabela_nao_enviados_ms			= "";
$tabela_nao_enviados_mt			= "";
$tabela_nao_enviados_to			= "";
$tabela_nao_enviados_ro			= "";
$tabela_nao_enviados_df			= "";

$total_geral_nao_enviados		= 0;
$total_encarregado_nao_enviados = 0;
$total_supervisor_nao_enviados	= 0;
$total_coordenador_nao_enviados	= 0;
$total_encarregado				= 0;
$total_supervisor				= 0;
$total_coordenador				= 0;
...
$tableResultado					= '';
$tableResultadoEmailAC			= '';
$tableResultadoEmailGO			= '';
$tableResultadoEmailMS			= '';
$tableResultadoEmailMT			= '';
$tableResultadoEmailTO			= '';
$tableResultadoEmailRO			= '';
$tableResultadoEmailDF			= '';
$cabecalhoResultado				= '';
$rodapeResultado				= '';
$assuntoResultado				= '';
$textoResultado					= '';
...
$enviadasResponsaveisAC			= 0;
$enviadasResponsaveisGO			= 0;
$enviadasResponsaveisMS			= 0;
$enviadasResponsaveisMT			= 0;
$enviadasResponsaveisTO			= 0;
$enviadasResponsaveisRO			= 0;
$enviadasResponsaveisDF			= 0;
$naoEnviadasResponsaveisAC		= 0;
$naoEnviadasResponsaveisGO		= 0;
$naoEnviadasResponsaveisMS		= 0;
$naoEnviadasResponsaveisMT		= 0;
$naoEnviadasResponsaveisTO		= 0;
$naoEnviadasResponsaveisRO		= 0;
$naoEnviadasResponsaveisDF		= 0;
$totalEnviadas					= 0;
$totalNaoEnviadas				= 0;
...
$Sql 								= "select pe.*, rmf.fun_filial from tbl_pessoal_encarregado pe
										...
										where rmf.fun_filial in('AC','RO','MS','MT','DF','GO','TO')
		...
		if ($emailSuperiorEncarregado){
			...
			if ($emailEnviado) {
				...
				if ($row_pessoal_encarregado['fun_filial'] == 'AC'){
					...
					$detalha_nao_enviados_e_ac .= $row_pessoal_encarregado['enc_nome']."<br>";
				}
				
				if ($row_pessoal_encarregado['fun_filial'] == 'GO'){
					$cont_nao_enviador_e_go ++;
					$detalha_nao_enviados_e_go .= $row_pessoal_encarregado['enc_nome']."<br>";
				}
				
				if ($row_pessoal_encarregado['fun_filial'] == 'TO'){
					$cont_nao_enviador_e_to ++;
					$detalha_nao_enviados_e_to .= $row_pessoal_encarregado['enc_nome']."<br>";
				}
				
				if ($row_pessoal_encarregado['fun_filial'] == 'RO'){
					$cont_nao_enviador_e_ro ++;
					$detalha_nao_enviados_e_ro .= $row_pessoal_encarregado['enc_nome']."<br>";
				}
				
				if ($row_pessoal_encarregado['fun_filial'] == 'DF'){
					$cont_nao_enviador_e_df ++;
					$detalha_nao_enviados_e_df .= $row_pessoal_encarregado['enc_nome']."<br>";
				}
				
				if ($row_pessoal_encarregado['fun_filial'] == 'MS'){
					$cont_nao_enviador_e_ms ++;
					$detalha_nao_enviados_e_ms .= $row_pessoal_encarregado['enc_nome']."<br>";
				}
				
				if ($row_pessoal_encarregado['fun_filial'] == 'MT'){
					$cont_nao_enviador_e_mt ++;
					$detalha_nao_enviados_e_mt .= $row_pessoal_encarregado['enc_nome']."<br>";
				}
			}
		}
	} else {
		...
		if ($emailSuperiorSupervisor){
			...
			if ($emailEnviado) {
				...
				if ($row_pessoal_supervisor['fun_filial'] == 'AC'){
					...
					$detalha_nao_enviados_s_ac .= $row_pessoal_supervisor['sup_nome']."<br>";
				}
				
				if ($row_pessoal_supervisor['fun_filial'] == 'GO'){
					$cont_nao_enviador_s_go ++;
					$detalha_nao_enviados_s_go .= $row_pessoal_supervisor['sup_nome']."<br>";
				}
				
				if ($row_pessoal_supervisor['fun_filial'] == 'TO'){
					$cont_nao_enviador_s_to ++;
					$detalha_nao_enviados_s_to .= $row_pessoal_supervisor['sup_nome']."<br>";
				}
				
				if ($row_pessoal_supervisor['fun_filial'] == 'RO'){
					$cont_nao_enviador_s_ro ++;
					$detalha_nao_enviados_s_ro .= $row_pessoal_supervisor['sup_nome']."<br>";
				}
				
				if ($row_pessoal_supervisor['fun_filial'] == 'DF'){
					$cont_nao_enviador_s_df ++;
					$detalha_nao_enviados_s_df .= $row_pessoal_supervisor['sup_nome']."<br>";
				}
				
				if ($row_pessoal_supervisor['fun_filial'] == 'MS'){
					$cont_nao_enviador_s_ms ++;
					$detalha_nao_enviados_s_ms .= $row_pessoal_supervisor['sup_nome']."<br>";
				}
				
				if ($row_pessoal_supervisor['fun_filial'] == 'MT'){
					$cont_nao_enviador_s_mt ++;
					$detalha_nao_enviados_s_mt .= $row_pessoal_supervisor['sup_nome']."<br>";
				}
			}
		}
	}else {
...
$Sql 							= "select pc.*, rmf.fun_filial from tbl_pessoal_coordenador pc
										inner join sigo_integrado.tbl_rm_funcionario rmf
...
EOF;
		...
		if ($emailSuperiorCoordenador){
			...
			echo '</span>';
			if ($emailEnviado) {
				if ($row_pessoal_coordenador['fun_filial'] == 'AC')
					$cont_ac_c ++;
				
				if ($row_pessoal_coordenador['fun_filial'] == 'GO')
					$cont_go_c ++;
				
				if ($row_pessoal_coordenador['fun_filial'] == 'TO')
					$cont_to_c ++;
				
				if ($row_pessoal_coordenador['fun_filial'] == 'RO')
					$cont_ro_c ++;
				
				if ($row_pessoal_coordenador['fun_filial'] == 'DF')
					$cont_df_c ++;
				
				if ($row_pessoal_coordenador['fun_filial'] == 'MS')
					$cont_ms_c ++;
				
				if ($row_pessoal_coordenador['fun_filial'] == 'MT')
					$cont_mt_c ++;
			}else {
				if ($row_pessoal_coordenador['fun_filial'] == 'AC'){
					$cont_nao_enviador_c_ac ++;
					$detalha_nao_enviados_c_ac .= $row_pessoal_coordenador['cor_nome']."<br>";
				}
				
				if ($row_pessoal_coordenador['fun_filial'] == 'GO'){
					$cont_nao_enviador_c_go ++;
					$detalha_nao_enviados_c_go .= $row_pessoal_coordenador['cor_nome']."<br>";
				}
				
				if ($row_pessoal_coordenador['fun_filial'] == 'TO'){
					$cont_nao_enviador_c_to ++;
					$detalha_nao_enviados_c_to .= $row_pessoal_coordenador['cor_nome']."<br>";
				}
				
				if ($row_pessoal_coordenador['fun_filial'] == 'RO'){
					$cont_nao_enviador_c_ro ++;
					$detalha_nao_enviados_c_ro .= $row_pessoal_coordenador['cor_nome']."<br>";
				}
				
				if ($row_pessoal_coordenador['fun_filial'] == 'DF'){
					$cont_nao_enviador_c_df ++;
					$detalha_nao_enviados_c_df .= $row_pessoal_coordenador['cor_nome']."<br>";
				}
				
				if ($row_pessoal_coordenador['fun_filial'] == 'MS'){
					$cont_nao_enviador_c_ms ++;
					$detalha_nao_enviados_c_ms .= $row_pessoal_coordenador['cor_nome']."<br>";
				}
				
				if ($row_pessoal_coordenador['fun_filial'] == 'MT'){
					$cont_nao_enviador_c_mt ++;
					$detalha_nao_enviados_c_mt .= $row_pessoal_coordenador['cor_nome']."<br>";
				}
			}
		}
	}else {
...
$total_enviados_ac 					= $cont_ac_e + $cont_ac_s + $cont_ac_c;
$total_enviados_go 					= $cont_go_e + $cont_go_s + $cont_go_c;
$total_enviados_ms 					= $cont_ms_e + $cont_ms_s + $cont_ms_c;
$total_enviados_mt 					= $cont_mt_e + $cont_mt_s + $cont_mt_c;
$total_enviados_to 					= $cont_to_e + $cont_to_s + $cont_to_c;
$total_enviados_ro 					= $cont_ro_e + $cont_ro_s + $cont_ro_c;
$total_enviados_df 					= $cont_df_e + $cont_df_s + $cont_df_c;

$total_nao_enviados_ac 				= $cont_nao_enviador_e_ac + $cont_nao_enviador_s_ac + $cont_nao_enviador_c_ac;
$total_nao_enviados_go 				= $cont_nao_enviador_e_go + $cont_nao_enviador_s_go + $cont_nao_enviador_c_go;
$total_nao_enviados_ms 				= $cont_nao_enviador_e_ms + $cont_nao_enviador_s_ms + $cont_nao_enviador_c_ms;
$total_nao_enviados_mt 				= $cont_nao_enviador_e_mt + $cont_nao_enviador_s_mt + $cont_nao_enviador_c_mt;
$total_nao_enviados_to 				= $cont_nao_enviador_e_to + $cont_nao_enviador_s_to + $cont_nao_enviador_c_to;
$total_nao_enviados_ro 				= $cont_nao_enviador_e_ro + $cont_nao_enviador_s_ro + $cont_nao_enviador_c_ro;
$total_nao_enviados_df 				= $cont_nao_enviador_e_df + $cont_nao_enviador_s_df + $cont_nao_enviador_c_df;
...
$total_coordenador					= $cont_df_c + $cont_ro_c + $cont_to_c + $cont_mt_c + $cont_ms_c + $cont_go_c + $cont_ac_c;
...
$total_coordenador_nao_enviados		= $cont_nao_enviador_c_df + $cont_nao_enviador_c_ro + $cont_nao_enviador_c_to + $cont_nao_enviador_c_mt + $cont_nao_enviador_c_ms + $cont_nao_enviador_c_go + $cont_nao_enviador_c_ac;
...
<body onload="javascript: setTimeout('getSecs()',1000);"  >  
	...
	<h1 class="cabecalho" align="center" > E-MAILS DE ACOMPANHAMENTO DA JORNADA DE TRABALHO DOS EMPREGADOS - AREA 2</h1>
...
$tableResultado = <<< EOF
	<table class="box_relatorio" align="center" width="800px">
		<tr class="cabecalho_tr">
			<td colspan="10" nowrap><span style="color:#FFFFFF;font-weight:bold;font-size: 16px;" id="clock1"></span></td>
		</tr>

		<tr class="cabecalho_tr">
			<td colspan="5" nowrap><span class="cabecalho_tr">E-MAILS ENVIADOS POR FILIAL</span></td>
			<td colspan="5" nowrap><span class="cabecalho_tr">E-MAILS NÃO ENVIADOS POR FILIAL</span></td>
		</tr>
		<tr class="subcabecalho_tr">
			<td>FILIAL</td>
			<td>COORDENADOR</td>
		...
		<tr class="tr_cor_branca" align="center">
			...
			<td>$cont_ac_s</td>
			<td>$cont_ac_e</td>
			<td>$total_enviados_ac</td>
			<td>$cont_nao_enviador_c_ac</td>
			<td>$cont_nao_enviador_s_ac</td>
			<td>$cont_nao_enviador_e_ac</td>
			<td colspan="2">$total_nao_enviados_ac</td>
		</tr>
		<tr class="tr_cor_cinsa" align="center">
			...
			<td>$cont_go_s</td>
			<td>$cont_go_e</td>
			<td>$total_enviados_go</td>
			<td>$cont_nao_enviador_c_go</td>
			<td>$cont_nao_enviador_s_go</td>
			<td>$cont_nao_enviador_e_go</td>
			<td colspan="2">$total_nao_enviados_go</td>
		</tr>
		<tr class="tr_cor_cinsa" align="center">
			<td>MS</td>
			<td>$cont_ms_c</td>
			<td>$cont_ms_s</td>
			<td>$cont_ms_e</td>
			<td>$total_enviados_ms</td>
			<td>$cont_nao_enviador_c_ms</td>
			<td>$cont_nao_enviador_s_ms</td>
			<td>$cont_nao_enviador_e_ms</td>
			<td colspan="2">$total_nao_enviados_ms</td>
		</tr>
		<tr class="tr_cor_cinsa" align="center">
			<td>MT</td>
			<td>$cont_mt_c</td>
			<td>$cont_mt_s</td>
			<td>$cont_mt_e</td>
			<td>$total_enviados_mt</td>
			<td>$cont_nao_enviador_c_mt</td>
			<td>$cont_nao_enviador_s_mt</td>
			<td>$cont_nao_enviador_e_mt</td>
			<td colspan="2">$total_nao_enviados_mt</td>
		</tr>
		<tr class="tr_cor_cinsa" align="center">
			<td>TO</td>
			<td>$cont_to_c</td>
			<td>$cont_to_s</td>
			<td>$cont_to_e</td>
			<td>$total_enviados_to</td>
			<td>$cont_nao_enviador_c_to</td>
			<td>$cont_nao_enviador_s_to</td>
			<td>$cont_nao_enviador_e_to</td>
			<td colspan="2">$total_nao_enviados_to</td>
		</tr>
		<tr class="tr_cor_cinsa" align="center">
			<td>RO</td>
			<td>$cont_ro_c</td>
			<td>$cont_ro_s</td>
			<td>$cont_ro_e</td>
			<td>$total_enviados_ro</td>
			<td>$cont_nao_enviador_c_ro</td>
			<td>$cont_nao_enviador_s_ro</td>
			<td>$cont_nao_enviador_e_ro</td>
			<td colspan="2">$total_nao_enviados_ro</td>
		</tr>
		<tr class="tr_cor_cinsa" align="center">
			<td>DF</td>
			<td>$cont_df_c</td>
			<td>$cont_df_s</td>
			<td>$cont_df_e</td>
			<td>$total_enviados_df</td>
			<td>$cont_nao_enviador_c_df</td>
			<td>$cont_nao_enviador_s_df</td>
			<td>$cont_nao_enviador_e_df</td>
			<td colspan="2">$total_nao_enviados_df</td>
		</tr>
		<tr class="subcabecalho_tr" align="center">
			...
			<td colspan="2">$total_geral_nao_enviados</td>
		</tr>
	</table>
EOF;

if ($detalha_nao_enviados_c_ac or $detalha_nao_enviados_s_ac or $detalha_nao_enviados_e_ac) {
	$tabela_nao_enviados_ac = <<< EOF
		<br>
		<table class="box_relatorio" align="center" width="800px">
			<tr class="cabecalho_tr">
			...
			<tr class="tr_cor_branca">
				<td valign="top">$detalha_nao_enviados_c_ac</td>
				<td valign="top">$detalha_nao_enviados_s_ac</td>
				<td valign="top">$detalha_nao_enviados_e_ac</td>
			</tr>
		</table>
EOF;
}

if ($detalha_nao_enviados_c_go or $detalha_nao_enviados_s_go or $detalha_nao_enviados_e_go) {
	$tabela_nao_enviados_go = <<< EOF
		<br>
		<table class="box_relatorio" align="center" width="800px">
			<tr class="cabecalho_tr">
				<td colspan="3" nowrap><span class="cabecalho_tr">LISTAGEM DOS E-MAILS NÃO ENVIADOS</span></td>
			...
			<tr class="tr_cor_branca">
				<td valign="top">$detalha_nao_enviados_c_go</td>
				<td valign="top">$detalha_nao_enviados_s_go</td>
				<td valign="top">$detalha_nao_enviados_e_go</td>
			</tr>
		</table>
EOF;
}

if ($detalha_nao_enviados_c_mt or $detalha_nao_enviados_s_mt or $detalha_nao_enviados_e_mt) {
	$tabela_nao_enviados_mt = <<< EOF
		<br>
		<table class="box_relatorio" align="center" width="800px">
			<tr class="cabecalho_tr">
				<td colspan="3" nowrap><span class="cabecalho_tr">LISTAGEM DOS E-MAILS NÃO ENVIADOS</span></td>
			...
			<tr class="tr_cor_branca">
				<td valign="top">$detalha_nao_enviados_c_mt</td>
				<td valign="top">$detalha_nao_enviados_s_mt</td>
				<td valign="top">$detalha_nao_enviados_e_mt</td>
			</tr>
		</table>
EOF;
}

if ($detalha_nao_enviados_c_ms or $detalha_nao_enviados_s_ms or $detalha_nao_enviados_e_ms) {
	$tabela_nao_enviados_ms = <<< EOF
		<br>
		<table class="box_relatorio" align="center" width="800px">
			<tr class="cabecalho_tr">
				<td colspan="3" nowrap><span class="cabecalho_tr">LISTAGEM DOS E-MAILS NÃO ENVIADOS</span></td>
			...
			<tr class="tr_cor_branca">
				<td valign="top">$detalha_nao_enviados_c_ms</td>
				<td valign="top">$detalha_nao_enviados_s_ms</td>
				<td valign="top">$detalha_nao_enviados_e_ms</td>
			</tr>
		</table>
EOF;
}

if ($detalha_nao_enviados_c_to or $detalha_nao_enviados_s_to or $detalha_nao_enviados_e_to) {
	$tabela_nao_enviados_to = <<< EOF
		<br>
		<table class="box_relatorio" align="center" width="800px">
			<tr class="cabecalho_tr">
				<td colspan="3" nowrap><span class="cabecalho_tr">LISTAGEM DOS E-MAILS NÃO ENVIADOS</span></td>
			...
			<tr class="tr_cor_branca">
				<td valign="top">$detalha_nao_enviados_c_to</td>
				<td valign="top">$detalha_nao_enviados_s_to</td>
				<td valign="top">$detalha_nao_enviados_e_to</td>
			</tr>
		</table>
EOF;
}

if ($detalha_nao_enviados_c_ro or $detalha_nao_enviados_s_ro or $detalha_nao_enviados_e_ro) {
	$tabela_nao_enviados_ro = <<< EOF
		<br>
		<table class="box_relatorio" align="center" width="800px">
			<tr class="cabecalho_tr">
				<td colspan="3" nowrap><span class="cabecalho_tr">LISTAGEM DOS E-MAILS NÃO ENVIADOS</span></td>
			...
			<tr class="tr_cor_branca">
				<td valign="top">$detalha_nao_enviados_c_ro</td>
				<td valign="top">$detalha_nao_enviados_s_ro</td>
				<td valign="top">$detalha_nao_enviados_e_ro</td>
			</tr>
		</table>
EOF;
}

if ($detalha_nao_enviados_c_df or $detalha_nao_enviados_s_df or $detalha_nao_enviados_e_df) {
	$tabela_nao_enviados_df = <<< EOF
		<br>
		<table class="box_relatorio" align="center" width="800px">
			<tr class="cabecalho_tr">
				<td colspan="3" nowrap><span class="cabecalho_tr">LISTAGEM DOS E-MAILS NÃO ENVIADOS</span></td>
			...
			<tr class="tr_cor_branca">
				<td valign="top">$detalha_nao_enviados_c_df</td>
				<td valign="top">$detalha_nao_enviados_s_df</td>
				<td valign="top">$detalha_nao_enviados_e_df</td>
			</tr>
		</table>
EOF;
}

$tableResultadoEmailAC = <<< EOF
	$estiloEmail
	<table class="box_relatorio" align="center" width="800px">
		<tr class="cabecalho_tr">
			<td colspan="5" nowrap><span class="cabecalho_tr">E-MAILS ENVIADOS POR FILIAL</span></td>
...
while ($row_responsaveis = mysqli_fetch_assoc($rs_responsaveis)) {
	if ($row_responsaveis['rp_filial'] == 'AC') {
		$textoEnvia 		= $tableResultadoEmailAC;
		$filialPorExtenso 	= " do ACRE";
	}
	if ($row_responsaveis['rp_filial'] == 'MT') {
		$textoEnvia 		= $tableResultadoEmailMT;
		$filialPorExtenso 	= " do MATO GROSSO";
	}
	if ($row_responsaveis['rp_filial'] == 'MS') {
		$textoEnvia 		= $tableResultadoEmailMS;
		$filialPorExtenso 	= " do MATO GROSSO DO SUL";
	}
	if ($row_responsaveis['rp_filial'] == 'TO') {
		$textoEnvia 		= $tableResultadoEmailTO;
		$filialPorExtenso 	= " de TOCANTINS";
	}
	if ($row_responsaveis['rp_filial'] == 'RO') {
		$textoEnvia 		= $tableResultadoEmailRO;
		$filialPorExtenso 	= " de RONDÔNIA";
	}
	if ($row_responsaveis['rp_filial'] == 'DF') {
		$textoEnvia 		= $tableResultadoEmailDF;
		$filialPorExtenso 	= " de BRASÍLIA";
	}
	if ($row_responsaveis['rp_filial'] == 'GO') {
		$textoEnvia 		= $tableResultadoEmailGO;
		$filialPorExtenso 	= " de GOIÁS";
	}
	...
	if ($textoResultado) {
		if ($row_responsaveis['rp_filial'] == 'AC') {
			$enviadasResponsaveisAC++;
		}
		if ($row_responsaveis['rp_filial'] == 'MT') {
			$enviadasResponsaveisMT++;
		}
		if ($row_responsaveis['rp_filial'] == 'MS') {
			$enviadasResponsaveisMS++;
		}
		if ($row_responsaveis['rp_filial'] == 'TO') {
			$enviadasResponsaveisTO++;
		}
		if ($row_responsaveis['rp_filial'] == 'RO') {
			$enviadasResponsaveisRO++;
		}
		if ($row_responsaveis['rp_filial'] == 'DF') {
			$enviadasResponsaveisDF++;
		}
		if ($row_responsaveis['rp_filial'] == 'GO') {
			$enviadasResponsaveisGO++;
		}
	}else {
		if ($row_responsaveis['rp_filial'] == 'AC') {
			$naoEnviadasResponsaveisAC++;
		}
		if ($row_responsaveis['rp_filial'] == 'MT') {
			$naoEnviadasResponsaveisMT++;
		}
		if ($row_responsaveis['rp_filial'] == 'MS') {
			$naoEnviadasResponsaveisMS++;
		}
		if ($row_responsaveis['rp_filial'] == 'TO') {
			$naoEnviadasResponsaveisTO++;
		}
		if ($row_responsaveis['rp_filial'] == 'RO') {
			$naoEnviadasResponsaveisRO++;
		}
		if ($row_responsaveis['rp_filial'] == 'DF') {
			$naoEnviadasResponsaveisDF++;
		}
		if ($row_responsaveis['rp_filial'] == 'GO') {
			$naoEnviadasResponsaveisGO++;
		}
	}
...
$totalEnviadas				= $enviadasResponsaveisAC + $enviadasResponsaveisMS + $enviadasResponsaveisMT + $enviadasResponsaveisTO + $enviadasResponsaveisRO + $enviadasResponsaveisDF + $enviadasResponsaveisGO;
$totalNaoEnviadas			= $naoEnviadasResponsaveisAC + $naoEnviadasResponsaveisMS + $naoEnviadasResponsaveisMT + $naoEnviadasResponsaveisTO + $naoEnviadasResponsaveisDF + $naoEnviadasResponsaveisGO + $naoEnviadasResponsaveisRO;
...
$tableResultadoResponsaveis = <<< EOF
	<table class="box_relatorio" align="center" width="500px">
		...
		<tr class="tr_cor_branca" align="center">
			<td>AC</td>
			<td>$enviadasResponsaveisAC</td>
			<td>$naoEnviadasResponsaveisAC</td>
		</tr>
		<tr class="tr_cor_branca" align="center">
			<td>MT</td>
			<td>$enviadasResponsaveisMT</td>
			<td>$naoEnviadasResponsaveisMT</td>
		</tr>
		<tr class="tr_cor_branca" align="center">
			<td>MS</td>
			<td>$enviadasResponsaveisMS</td>
			<td>$naoEnviadasResponsaveisMS</td>
		</tr>
		<tr class="tr_cor_branca" align="center">
			<td>TO</td>
			<td>$enviadasResponsaveisTO</td>
			<td>$naoEnviadasResponsaveisTO</td>
		</tr>
		<tr class="tr_cor_cinsa" align="center">
			<td>RO</td>
			<td>$enviadasResponsaveisRO</td>
			<td>$naoEnviadasResponsaveisRO</td>
		</tr>
		<tr class="tr_cor_cinsa" align="center">
			<td>DF</td>
			<td>$enviadasResponsaveisDF</td>
			<td>$naoEnviadasResponsaveisDF</td>
		</tr>
		<tr class="tr_cor_cinsa" align="center">
			<td>GO</td>
			<td>$enviadasResponsaveisGO</td>
			<td>$naoEnviadasResponsaveisGO</td>
		</tr>
		<tr class="subcabecalho_tr" align="center">
			<td>TOTAL GERAL</td>
			<td>$totalEnviadas</td>
